...
while True:
    ...
    if Terminal.IsRushing():
      ...
      Packet.SendPacket(oPacket)
      time.sleep(5)
      oPacket = Packet.COutPacket(0x00BB)
      oPacket.Encode4(int(time.monotonic()*1000))
      oPacket.Encode1(0x00)
      Packet.SendPacket(oPacket)
      time.sleep(1)
      ...
      Packet.SendPacket(oPacket)
      time.sleep(9)
      oPacket = Packet.COutPacket(0x00B5)
      Packet.SendPacket(oPacket)
      time.sleep(9)
      ...
      time.sleep(3)
      oPacket = Packet.COutPacket(0x00CF)#Skips boring cutscene
      oPacket.Encode4(int(time.monotonic()*1000))
      oPacket.Encode4(0x00532A20)
      oPacket.Encode1(0xFD)
      oPacket.Encode1(0x00)
      ...
      time.sleep(3)
      oPacket = Packet.COutPacket(0x00B5)#DC to login screen
      Packet.SendPacket(oPacket)
      break#By Cotopian