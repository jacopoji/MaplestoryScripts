...
idFilter        = 1
idWhiteList     = [10,53,102,103,115,116,114]
idBlackList     = []
...
mapFilter       = 1
mapWhiteList    = [866000130,100020400,101030500,120040100,120040100,120040300,120041000,120041100,120041200,120041300,120041400,120041500,120041600,120041700,120041800,103030000,102030000,105010301,211040200,260020500,261020300,240010700,224000100,251010100,103041115,221030400,221030620,271030540,273020000,240010600,260020700]
mapBlackList    = []
