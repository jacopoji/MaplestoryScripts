...
profile_path = 'C:/Users/Jacopo/Desktop/TerminalManager/terminalProfiles/Lvl149Kanna.xml'
...
while True:
    ...
    if job == -1:
        break
    if job != -1 and Character.GetMeso() == 0:
    ...
    if job != -1 and Character.GetMeso() == 29999999999 and withdrawed_flag== True:
        f = open(r'C:\Users\Jacopo\Desktop\Scripts\StoreMeso\%s.txt' % CharName,'r')
        temp = f.read()
        f.close()
        f = open(r'C:\Users\Jacopo\Desktop\Scripts\StoreMeso\%s.txt' % CharName,'w')
    ...
    elif job != -1 and Character.GetMeso() != 0 and withdrawed_flag== False:
        f = open(r'C:\Users\Jacopo\Desktop\Scripts\StoreMeso\%s.txt' % CharName,'r')
        temp = f.read()
        f.close()
        f = open(r'C:\Users\Jacopo\Desktop\Scripts\StoreMeso\%s.txt' % CharName,'w')
