# Download - https://hostr.co/GBCoSJjVdb4c
# Hyper Skill Assigner by dolbaeb!!! edited by lalaefi.
# v1 - 27/09/2018
# v2 - 05/10/2018 <- updated opcodes v199
# v3 - 07/10/2018 <- added Power Unity
# v4 - 08/10/2018 <- added more skills
# v5 - 17/11/2018 <- updated opcodes v200
...
class Wild_Hunter():
   Silent_Rampage = [33121054, 0x76] # VK_F7

class Night_Walker():
   Dominion = [14121052, 0x75] # VK_F6
